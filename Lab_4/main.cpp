...
public:
    ...
    std::vector<uint8_t> decrypt(const std::vector<uint8_t> &data) {
        if (data.size() % 8 != 0) {
            throw std::runtime_error("Invalid data size for Blowfish decryption");
        }
...
int main() {
    ...
    try {
        ...
        // Шифрование
        auto encrypted = bf.encrypt(data);
        std::cout << "\nЗашифрованный (hex): ";
        printHex(encrypted);
